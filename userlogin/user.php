...
<head>
	<title>AdminPlus - Premium Bootstrap Admin Template (v1.1) - shared on themelock.com</title>
	...
	<div class="container-fluid fixed">
		...
		<div class="navbar main">
			...
			<ul class="topnav pull-right">
				...
				<li class="account">
										<a data-toggle="dropdown" href="logout.php?lang=en" class="glyphicons logout lock"><span class="hidden-phone text">Logout</span><i></i></a>
					<ul class="dropdown-menu pull-right">
						...
						<li class="highlight profile">
							<span>
								<span class="heading">Profile <a href="account.php?lang=en" class="pull-right">edit</a></span>
								<span class="img"></span>
								<span class="details">
									<a href="logout.php?lang=en">Logout</a>
...
<div class="widget widget-2 widget-tabs widget-tabs-2">
	<div class="widget-head">
		<ul>
			<li class="active"><a class="glyphicons cardio" href="#website-traffic-tab" data-toggle="tab"><i></i>Companies</a></li>
...
/*
// Perform Query
$query="SELECT * from companies ORDER BY symbol ASC LIMIT 100";
...
if ($count%6 ==0 ) echo '<div class="row-fluid">';
echo '<div class="span2">';
echo '<div class="tile black-tooltip" data-toggle="tooltip" title="Sector:';
echo $row['sector'];
echo ' Industry:';
echo $row['industry'];
echo '"><h2>';
echo $row['symbol'];
echo '</h2><span class="cmp-name">'.$row['title'].'</span></div>';

echo "</div>";
$count++;
if ($count%6 ==0 && $count!=0) echo "</div>";
