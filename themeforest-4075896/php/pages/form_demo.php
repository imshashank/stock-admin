...
<!-- <h3 class="glyphicons user"><i></i> <?php echo $translate->_('my_account'); ?></h3> -->

<div class="widget widget-2 widget-tabs widget-tabs-2 tabs-right border-bottom-none">
	<div class="widget-head">
		<ul>
			<li class="active"><a class="glyphicons settings" href="#account-settings" data-toggle="tab"><i></i><?php echo $translate->_('account_settings'); ?></a></li>
			<li><a class="glyphicons user" href="#account-details" data-toggle="tab"><i></i><?php echo $translate->_('account_details'); ?></a></li>
		</ul>
	</div>
</div>
